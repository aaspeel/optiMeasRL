        ...
        for i, dim in enumerate(self._input_dimensions):
            ...
            # - observation[i] is a VECTOR
                ...
                if dim[0] > 3:
                    ...
                    x = Conv2D(10, (2, 1), activation='relu', padding='valid')(reshaped)#Conv on the history
                    x = Conv2D(10, (2, 1), activation='relu', padding='valid')(x)       #Conv on the history & features
            ...
            # - observation[i] is a SCALAR -
                ...
                if dim[0] > 3:
                    ...
                    x = Conv2D(10, (1,2), activation='relu', padding='valid')(reshaped)  #Conv on the history
                    x = Conv2D(10, (1,2), activation='relu', padding='valid')(x)         #Conv on the history
